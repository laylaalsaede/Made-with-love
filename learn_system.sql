...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2020 at 01:15 AM
...
(58, 'Burger', 15, 'chicken burger', 1, '1.jpg', 'ENABLE'),
(59, 'Pizza', 20, 'chicken BBQ pizza', 2, '2.jpg', 'ENABLE'),
(60, 'Spanakopita', 99, 'Small pie\r\n', 1, '7.jpg', 'ENABLE'),
(61, 'pasta', 80, 'chicken pasts', 1, '5.jpg', 'ENABLE'),
(62, 'Spring Rolls', 65, 'Delicious Spring Rolls by Dragon Hut, Delhi. Order now!!!', 2, 'Spring_Rolls.jpg', 'ENABLE'),
(63, 'Baahubali Thali', 75, 'Baahubali Thali is accompanied by Kattapa Biriyani, Devasena Paratha, Bhalladeva Patiala Lassi', 3, 'Baahubali_Thali.jpg', 'ENABLE'),
...
('', '', '', ''),
('layla', 'layla.alsaede@gmail.com', '+966500920176', '1234');
...
--
ALTER TABLE `orders`
  MODIFY `order_ID` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
